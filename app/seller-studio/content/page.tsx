...
export const metadata: Metadata = { alternates: { canonical: "/seller-studio/content" }, title: "Seller Studio Content", description: "Create shoppable Stories, Reels, and commerce content from catalogue data.",
  openGraph: {
    url: "/seller-studio/content",
    title: "Seller Studio Content",
    description: "Create shoppable Stories, Reels, and commerce content from catalogue data.",
  },
  twitter: {

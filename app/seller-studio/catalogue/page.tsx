...
export const metadata: Metadata = { alternates: { canonical: "/seller-studio/catalogue" }, title: "Seller Studio Catalogue", description: "Catalogue manager for Shopify, WooCommerce, CSV imports, AI tagging, and product enrichment.",
  openGraph: {
    url: "/seller-studio/catalogue",
    title: "Seller Studio Catalogue",
    description: "Catalogue manager for Shopify, WooCommerce, CSV imports, AI tagging, and product enrichment.",
  },
  twitter: {

...
export const metadata: Metadata = { alternates: { canonical: "/seller-studio/orders" }, title: "Seller Studio Orders", description: "AI order management for WhatsApp, voice, Stories, and Shopify orders.",
  openGraph: {
    url: "/seller-studio/orders",
    title: "Seller Studio Orders",
    description: "AI order management for WhatsApp, voice, Stories, and Shopify orders.",
  },
  twitter: {

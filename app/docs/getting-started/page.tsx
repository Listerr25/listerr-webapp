...
export const metadata: Metadata = { alternates: { canonical: "/docs/getting-started" }, title: "Getting Started Docs", description: "Install Listerr SDKs and publish your first Story.",
  openGraph: {
    url: "/docs/getting-started",
    title: "Getting Started Docs",
    description: "Install Listerr SDKs and publish your first Story.",
  },
  twitter: {

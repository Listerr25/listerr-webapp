...
export const metadata: Metadata = { alternates: { canonical: "/network/brands" }, title: "Listerr Network for Brands", description: "Hire verified commerce creators and run regional content campaigns.",
  openGraph: {
    url: "/network/brands",
    title: "Listerr Network for Brands",
    description: "Hire verified commerce creators and run regional content campaigns.",
  },
  twitter: {

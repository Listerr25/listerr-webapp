...
export const metadata: Metadata = { alternates: { canonical: "/storyboard/ai-editor" }, title: "Storyboard AI Editor", description: "AI-assisted commerce content editor for product-led Stories and Reels.",
  openGraph: {
    url: "/storyboard/ai-editor",
    title: "Storyboard AI Editor",
    description: "AI-assisted commerce content editor for product-led Stories and Reels.",
  },
  twitter: {

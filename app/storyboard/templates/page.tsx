...
export const metadata: Metadata = { title: "Storyboard Templates", description: "Filterable commerce Story and Reel templates by industry, format, and campaign goal." }

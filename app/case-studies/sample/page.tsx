...
export const metadata: Metadata = { alternates: { canonical: "/case-studies/sample" }, title: "Sample Case Study", description: "Sample Listerr case study template.",
  openGraph: {
    url: "/case-studies/sample",
    title: "Sample Case Study",
    description: "Sample Listerr case study template.",
  },
  twitter: {

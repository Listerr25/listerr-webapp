...
export const metadata: Metadata = { title: "Gamification for Commerce", description: "Streaks, spin wheels, scratch cards, badges, challenges, and leaderboards for commerce engagement." }

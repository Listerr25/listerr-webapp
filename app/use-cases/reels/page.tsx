...
export const metadata: Metadata = {
  alternates: { canonical: "/use-cases/reels" },
  ...
  openGraph: {
    url: "/use-cases/reels",
    title: "Reels & Video — Shoppable vertical video inside your app",
    description: "TikTok-style vertical video with shoppable overlays, creator attribution, autoplay, and revenue analytics.",
  },
  twitter: {

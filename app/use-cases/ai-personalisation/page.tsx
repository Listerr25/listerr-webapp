...
export const metadata: Metadata = { alternates: { canonical: "/use-cases/ai-personalisation" }, title: "AI Personalisation", description: "Real-time AI scoring across Stories, Reels, and Lists for personalised commerce content.",
  openGraph: {
    url: "/use-cases/ai-personalisation",
    title: "AI Personalisation",
    description: "Real-time AI scoring across Stories, Reels, and Lists for personalised commerce content.",
  },
  twitter: {

...
export const metadata: Metadata = {
  alternates: { canonical: "/use-cases/customer-lists" },
  ...
  openGraph: {
    url: "/use-cases/customer-lists",
    title: "Customer Lists — Listerr's signature interactive format",
    description: "Curated, ranked, interactive customer lists that users browse, vote, save, and buy from.",
  },
  twitter: {

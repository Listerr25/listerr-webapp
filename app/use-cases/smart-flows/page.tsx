...
export const metadata: Metadata = { alternates: { canonical: "/use-cases/smart-flows" }, title: "Smart Flows", description: "Outcome-driven multi-step commerce flows for cart recovery, onboarding, re-engagement, post-purchase, and festivals.",
  openGraph: {
    url: "/use-cases/smart-flows",
    title: "Smart Flows",
    description: "Outcome-driven multi-step commerce flows for cart recovery, onboarding, re-engagement, post-purchase, and festivals.",
  },
  twitter: {

...
export const metadata: Metadata = { title: "Meta & Google Sync", description: "Turn top-performing Stories into Meta and Google ads with catalogue, pixel, GA4, and remarketing sync." }

...
export const metadata: Metadata = { alternates: { canonical: "/industries/edtech" }, title: "EdTech Industry", description: "Listerr for course discovery, learner activation, and daily engagement.",
  openGraph: {
    url: "/industries/edtech",
    title: "EdTech Industry",
    description: "Listerr for course discovery, learner activation, and daily engagement.",
  },
  twitter: {

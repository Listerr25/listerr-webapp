...
export const metadata: Metadata = { alternates: { canonical: "/platform" }, title: "Platform Overview", description: "One platform, four products, built to grow Indian commerce.",
  openGraph: {
    url: "/platform",
    title: "Platform Overview",
    description: "One platform, four products, built to grow Indian commerce.",
  },
  twitter: {

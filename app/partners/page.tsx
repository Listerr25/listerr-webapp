...
export const metadata: Metadata = { alternates: { canonical: "/partners" }, title: "Listerr Partners", description: "Agency, technology, solution, and reseller partner programmes.",
  openGraph: {
    url: "/partners",
    title: "Listerr Partners",
    description: "Agency, technology, solution, and reseller partner programmes.",
  },
  twitter: {

...
export const metadata: Metadata = {
  alternates: { canonical: "/ai/text-ordering" },
  title: "AI Text Ordering",
  description:
    "WhatsApp, SMS, and in-app chat become automated order channels powered by Listerr AI.",
  openGraph: {
    url: "/ai/text-ordering",
    title: "AI Text Ordering",
    description: "WhatsApp, SMS, and in-app chat become automated order channels powered by Listerr AI.",
  },
  twitter: {
